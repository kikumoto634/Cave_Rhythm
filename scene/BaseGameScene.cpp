...
const float BaseGameScene::Plane_Size = 2.5f;

BaseGameScene::BaseGameScene(DirectXCommon *dxCommon, Window *window, int saveHP)
		: BaseScene(
		dxCommon,
		window)
{
...
void BaseGameScene::Application()
{
...
#pragma region 初期化
void BaseGameScene::CommonInitialize()
{
	//衝突マネージャー
...
void BaseGameScene::Object3DInitialize()
{
...
void BaseGameScene::Object2DInitialize()
{
	//シーン遷移(FadeOut)
...
#pragma region 更新
void BaseGameScene::InputUpdate()
{
...
void BaseGameScene::Object3DUpdate()
{
	//プレイヤー
...
void BaseGameScene::Object2DUpdate()
{
	gameManager->SpriteUpdate();
}

void BaseGameScene::CommonUpdate()
{
...
void BaseGameScene::RhythmMeasure()
{
	//計測開始
	if(IsPrevSceneChange) return;
...
void BaseGameScene::RhythmJudgeUpdate()
{
	if(IsPrevSceneChange) return;
...
void BaseGameScene::BeatEndUpdate()
{
	if(IsPrevSceneChange) return;
...
#pragma region 描画
void BaseGameScene::Object3DDraw()
{
	player->Draw();
...
#pragma region シーン更新
void BaseGameScene::SceneGameEnd()
{
	//sceneManager->SetNextScene(new TitleScene(dxCommon,window));
}

void BaseGameScene::SceneChange()
{
	//PrevSceneからの移動後処理
...
#pragma region 後処理
void BaseGameScene::ObjectFinaize()
{
#pragma region _3D解放
	player->Finalize();
	for(int i = 0; i < DIV_NUM; i++){
...
void BaseGameScene::CommonFinalize()
{
